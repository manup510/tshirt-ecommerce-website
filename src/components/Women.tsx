...
import img1 from "../../public/Images/women/images (9).jpg";
import img2 from "../../public/Images/women/images (2).jpg";
import img3 from "../../public/Images/women/images (10).jpg";
import img4 from "../../public/Images/women/images (3).jpg";
import img5 from "../../public/Images/women/images (5).jpg";
import img6 from "../../public/Images/women/images (8).jpg";
import img7 from "../../public/Images/women/images (4).jpg";
import img8 from "../../public/Images/women/download.jpg";
import img9 from "../../public/Images/women/images (5).jpg";
import img10 from "../../public/Images/women/images.jpg";
...
export default function Imgcomp() {
    return(
        <>
        <div className="grid lg:grid-rows-3 lg:grid-cols-4 sm:grid-cols-2 sm:grid-rows-6 grid-cols-1 ml-16 gap-2 ">
        {
            Images.map((e)=>(
                <div key={e.id}>
